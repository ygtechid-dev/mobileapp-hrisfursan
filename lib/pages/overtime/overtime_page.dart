  ...
  Widget build(BuildContext context) {
    ...
    return GeneralPage(
            ...
            children: [
              (selectedTab == "Request") ? (listData.isEmpty) ? Container(
                ...
                child: Column(
                    ...
                    children: [
                      Text(
                        "No Overtime Submitted!",
                        textAlign: TextAlign.start,
                        style: blackFontStyle.copyWith(fontSize: 14, fontWeight: FontWeight.w600),
                      ),
                      SizedBox(height: 5),
                      Text(
                        "Ready to catch some fresh air? Click “Submit Overtime” and \ntake that well-deserved break!",
                        textAlign: TextAlign.start,
                  ...
                  children: [
                    Column(
                        children: listData.map((e) => OvertimeItemCard(defaultWidth, date: e[0], overtime_date: e[1], priority: e[2], category: e[3], status: e[4], type: e[5])).toList()
                    ),
                  ]
              ) : SizedBox(),
              (selectedTab == "Status") ? (listData2.isEmpty) ? Container(
                ...
                child: Column(
                  ...
                  children: [
                    Column(
                        children: listData2.map((e) => OvertimeItemCard(defaultWidth, date: e[0], overtime_date: e[1], priority: e[2], category: e[3], status: e[4], type: e[5])).toList()
                    ),
                  ]
              ) : SizedBox(),
            ]
      ...
      navBar: Container(
        ...
        child: ButtonCard("Submit Overtime", defaultWidth - 2*24, mainColor, colorGradient: buttonGradient, onPressed: () async {
          Get.to(OvertimeCreatePage());
        }),
      ),
    );
  }
